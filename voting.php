...
<body>
    ...
    <div class="absolute top-0 right-0 p-4 md:p-6 z-10 flex space-x-2">
        <a href="index.php" class="bg-gray-600 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded-lg text-sm md:text-base transition-colors duration-300 shadow-md">
            Beranda
        </a>
